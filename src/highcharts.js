const highchartJS = () => {
    waitForElement("#highchartContainer1, highchartContainer2", 8000)
        .then(function () {
            console.log("container is loaded.. do stuff");
            highchartScript();
            highchartScript2();
        })
        .catch(() => {
            console.log("container did not load in 8 seconds");
        });
};
